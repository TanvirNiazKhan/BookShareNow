...
<body class="bg-[#191919]">
    ...
    <div class="bg-[#cac7bd] text-[#191919] py-2 px-4 text-right">
        <p>Logged in as: <?php echo $user['name']; ?></p>
        ...
        <div class="container mx-auto">
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="max-w-md mx-auto border-2 border-[#cac7bd] text-[#cac7bd] bg-[#191919] shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div class="mb-4">
                    ...
                    <!-- add select here -->
                    <select id="category" name="category" class="border border-[#cac7bd] text-[#191919] bg-[#cac7bd] focus:ring-[#cac7bd] focus:border-[#cac7bd] rounded-lg py-2 px-4 w-full">
                    ...
                    <input type="text" id="category" name="category" class="hidden border border-[#cac7bd] text-[#191919] bg-[#cac7bd] focus:ring-[#cac7bd] focus:border-[#cac7bd] rounded-lg py-2 px-4 w-full mt-2" placeholder="Enter a category" required>
