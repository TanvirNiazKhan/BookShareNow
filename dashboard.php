        ...
        <!-- <h2 class="text-3xl leading-9  tracking-tight text-center  sm:text-4xl sm:leading-10 text-[#cac7bd] p-4">
            ...
            <form class="max-w-md mx-auto">
                ...
                <div class="relative">
                    ...
                    <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-[#191919] focus:ring-blue-500 focus:border-blue-500   bg-gray-700   border-gray-600   placeholder-gray-400   text-white   focus:ring-blue-500   focus:border-blue-500" placeholder="Search books...." required />
                    <button type="submit" class="text-[#cac7bd] absolute end-2.5 bottom-2.5  focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-4 py-2 bg-[#191919]   hover:bg-[#cac7bd]   hover:text-[#191919]   focus:ring-blue-800">Search</button>
                </div>
            </form> -->
        ...
        <section class=" p-6 ">
            ...
            <div class="relative overflow-x-auto w-2/3 mx-auto">
                <table class="w-full text-sm text-left rtl:text-right text-[#cac7bd] rounded-lg border-2 border-[#cac7bd]">
                    ...
                    <tbody>
                        <tr class=" border-b      border-[#cac7bd]">
                            <th scope="row" class="px-6 py-4 font-medium text-[#cac7bd]  whitespace-nowrap   ">
                        ...
                        <tr class=" border-b border-[#cac7bd]">
                            <th scope="row" class="px-6 py-4 font-medium  whitespace-nowrap   text-[#cac7bd]">
